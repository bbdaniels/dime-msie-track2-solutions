   ...
   * ******************************************************************** *
   *                                                                      *
   *               LAB4 ANALYSIS MASTER DO_FILE                           *
   *               This master dofile calls all dofiles related           *
   *               to analysis in the Lab4 round.                         *
   *                                                                      *
   * ******************************************************************** *
   * ******************************************************************** *
   ...
   * ***************************************************** *
       ...
       *do "$Lab4_doAnl/dofile2.do" //Give your dofile a more informative name, this is just a place holder name
   ...
   * ***************************************************** *
       ...
       *do "$Lab4_doAnl/dofile3.do" //Give your dofile a more informative name, this is just a place holder name
