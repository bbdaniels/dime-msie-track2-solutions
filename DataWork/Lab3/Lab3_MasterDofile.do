...
*iefolder will not work properly if the line above is edited
   ...
   *Encrypted round sub-folder globals
   ...
   global Lab3_dtRaw             "$Lab3_encrypt/Raw Identified Data"
   global Lab3_doImp             "$Lab3_encrypt/Dofiles Import"
   global Lab3_HFC               "$Lab3_encrypt/High Frequency Checks"

   *DataSets sub-folder globals
   global Lab3_dt                "$Lab3/DataSets"
   global Lab3_dtInt             "$Lab3_dt/Intermediate"
   global Lab3_dtFin             "$Lab3_dt/Final"

   *Dofile sub-folder globals
   global Lab3_do                "$Lab3/Dofiles"
   global Lab3_doCln             "$Lab3_do/Cleaning"
   global Lab3_doCon             "$Lab3_do/Construct"
   global Lab3_doAnl             "$Lab3_do/Analysis"

   *Output sub-folder globals
   global Lab3_out               "$Lab3/Output"
   global Lab3_outRaw            "$Lab3_out/Raw"
   global Lab3_outFin            "$Lab3_out/Final"

   *Questionnaire sub-folder globals
   global Lab3_prld              "$Lab3_quest/PreloadData"
   global Lab3_doc               "$Lab3_quest/Questionnaire Documentation"
...
*iefolder will not work properly if the line above is edited
   ...
   *            Lab3 should be replicated, including output of
   *            tablets, graphs, etc.
