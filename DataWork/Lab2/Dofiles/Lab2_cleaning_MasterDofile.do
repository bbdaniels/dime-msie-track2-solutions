   ...
   * ******************************************************************** *
   *                                                                      *
   *               LAB2 CLEANING MASTER DO_FILE                           *
   *               This master dofile calls all dofiles related           *
   *               to cleaning in the Lab2 round.                         *
   *                                                                      *
   * ******************************************************************** *
   * ******************************************************************** *
   ...
   * ***************************************************** *
       ...
       *do "$Lab2_doCln/dofile2.do" //Give your dofile a more informative name, this is just a place holder name
   ...
   * ***************************************************** *
       ...
       *do "$Lab2_doCln/dofile3.do" //Give your dofile a more informative name, this is just a place holder name
