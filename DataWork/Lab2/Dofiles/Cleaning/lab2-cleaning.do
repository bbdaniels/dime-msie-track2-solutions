...
* Load the dataset
	...
	use "${Lab2_dtInt}/endline_data_raw.dta", clear
...
* Trim to variables
	...
	local inc inc_01 inc_02 inc_03 inc_06 inc_08 inc_09 inc_12 inc_13 inc_14 inc_15 inc_16 inc_17 inc_t
...
* Save
	...
	saveold "${Lab2_dtFin}/Lab2_endline_data_final.dta", replace v(12) 	// <- [saveold] is a nice thing to do.
		use "${Lab2_dtFin}/Lab2_endline_data_final.dta", clear			// <- trust me, this comes in handy.
